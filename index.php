...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #C0392B;">
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Create an Account</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-2 py-2">
        <p>&copy 2021. Made by <b>Pratik Jadav</b></p>
      </footer>
